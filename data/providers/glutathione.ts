...
export const glutathioneProviders: Provider[] = [
  {
    ...
    shortDescription: 'System offers clinician-prescribed glutathione therapy starting at just $79 for your first month, one of the lowest entry prices in the market. Every plan supports healthy aging, detox, and recovery, and ships free directly to your door. If you want an affordable, fully online path to pharmaceutical-grade glutathione without clinic visits, System is the clear first choice.',
    ...
    features: [
      'Starting at just $79 for your first month',
      'Supports healthy aging, detox & recovery',
      'Online treatment with free shipping included',
    ],
    pros: [
      'Lowest entry price at $79 for your first month',
      'Supports healthy aging, detox, and recovery goals',
      'Free shipping on every order, no hidden fees',
      'Fully online, no clinic visits required',
      'Clinician-prescribed pharmaceutical-grade glutathione',
    ],
    cons: [
      'Ongoing monthly price confirmed after intake',
      'Compounded glutathione, not an FDA-approved finished product',
    ],
    priceRange: 'From $79 first month',
    bestFor: 'Anyone looking for affordable, clinician-prescribed glutathione therapy for detox, healthy aging, and recovery, delivered free to their door',
    reviewContent: {
      intro: 'System has built a compelling case as the most accessible entry point into glutathione therapy. By combining a $79 first-month offer with free shipping and a fully online experience, they have removed the two biggest barriers, cost and convenience, that keep patients from starting. The result is a platform that genuinely delivers on its promise: high-quality glutathione without a high upfront commitment.',
      whatIsIt: 'System is a fully online telehealth platform offering clinician-prescribed glutathione therapy designed to support healthy aging, detoxification, and recovery. Glutathione, often called the "master antioxidant", is a tripeptide produced naturally by the body that plays a central role in neutralizing free radicals, supporting liver detox pathways, and protecting cells from oxidative stress. System sources pharmaceutical-grade glutathione from licensed compounding pharmacies and ships it directly to patients with clinician oversight built in.',
      howItWorks: 'Getting started with System takes minutes online. You complete a brief health intake, a licensed clinician reviews your case and prescribes your glutathione protocol, and your first shipment is prepared at a licensed compounding pharmacy. Free shipping means your first month arrives without any hidden fees. Ongoing care is managed through the System platform, with clinician access available for protocol adjustments as your goals evolve.',
      whoIsItFor: 'System is the right choice for patients who want to start glutathione therapy without a large upfront financial commitment and without the complexity of boutique clinic processes. If you are focused on detox support, healthy aging, or recovery optimization and want a straightforward, doctor-prescribed option that ships free, System delivers exactly that at the most accessible price point in this market.',
      pricingDetails: 'System offers glutathione therapy starting at just $79 for your first month, significantly lower than most telehealth glutathione providers. Free shipping is included on every order. Ongoing monthly pricing after the first month is presented during the intake process based on your personalized protocol. There are no surprise fees at checkout.',
      ourVerdict: 'System earns the top spot on this page by delivering what matters most: accessible pricing, quality sourcing, free shipping, and a fully online experience. The $79 first-month offer dramatically lowers the cost of entry, and the support for healthy aging, detox, and recovery covers the three most common reasons patients seek glutathione therapy. For patients who want to start now without overcomplicating the process, System is the strongest option available.',
    },
    faq: [
      {
        question: 'How does the $79 first-month offer work at System?',
        answer: 'New System patients start at just $79 for their first month of glutathione therapy. The discounted pricing is applied at signup, no coupon code required. Ongoing monthly pricing is presented during intake based on your personalized protocol.',
      },
      {
        question: 'What does System glutathione support?',
        answer: 'System glutathione therapy is designed to support healthy aging, detoxification, and recovery. Glutathione is the body\'s primary antioxidant, and supplementing with pharmaceutical-grade formulations helps neutralize oxidative stress, support liver detox pathways, and protect cellular health.',
      },
      {
        question: 'Is free shipping always included with System?',
        answer: 'Yes. Every System order includes free shipping to your door from a licensed compounding pharmacy, no add-on fulfillment fees.',
      },
      {
  ...
  },
  {
    ...
    reviewContent: {
      ...
      ourVerdict: 'Hone Health earns the #3 position by delivering what matters to the most serious glutathione patients: lab-informed protocols, clinical depth, and real personalization. The $79 System entry point remains the best for patients who want to start affordably, but for patients who want their therapy built around their actual biomarkers, Hone Health delivers a meaningfully superior clinical experience.',
    },
    faq: [
      {
