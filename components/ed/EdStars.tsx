import { ED_STAR_FILL, ED_STAR_EMPTY } from './theme';

/**
 * Five-star row for the ED comparison page.
 *
 * Separate from `components/providers/AffordableProviderCard`'s `StarRow`
 * because the reference uses different colours (#F3B42C filled over a #E5E5E5
 * track) and a continuous partial fill rather than half-star rounding — a 9.71
 * shows as 97.1% of the row, not four-and-a-half stars.
 *
 ...
 * page.
 */
export function EdStars({ rating, size = 14 }: { rating: number; size?: number }) {
